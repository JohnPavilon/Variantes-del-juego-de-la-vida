...
def main():
    ...
    pygame.display.set_caption("Variante 235678/3678 (Mancha de Tinta)")
        ...
        for y in range(0, celX):
            for x in range(0, celY):
                ...
                if not pause: 
                    ...
                    if gameState[x,y] == 0 and (neighbor == 3 or (neighbor >= 6 and neighbor <= 8)):
                        copyState[x,y]=1
                    
                    #Si una célula esta viva y tiene menos de 2, igual a 4 o más de 8 vecinos vivos, muere
                    elif gameState[x,y] == 1 and (neighbor < 2 or neighbor == 4 or neighbor > 8):
                        copyState[x,y]=0
