...
def main():
    ...
    pygame.display.set_caption("Variante 245/368 (muerte, locomotoras y naves)")
        ...
        for y in range(0, celX):
            for x in range(0, celY):
                ...
                if not pause: 
                    ...
                    #Si una célula esta muerta y tiene 3,6,7 u 8 vecinos vivos, resucita
                    if gameState[x,y] == 0 and (neighbor == 3 or neighbor == 6 or neighbor == 8):
                        copyState[x,y]=1
                    
                    #Si una célula esta viva y tiene menos de 2, igual a 4 o más de 8 vecinos vivos, muere
                    elif gameState[x,y] == 1 and (neighbor == 2 or neighbor == 4 or neighbor > 5):
                        copyState[x,y]=0
