...
def main():
    ...
    pygame.display.set_caption("Variante 51/346 «Larga vida»")
        ...
        for y in range(0, celX):
            for x in range(0, celY):
                ...
                if not pause: 
                    ...
                    if gameState[x,y] == 0 and (neighbor == 3 or neighbor == 4 or neighbor == 6):
                        copyState[x,y]=1
                    
                    #Si una célula esta viva y tiene 1 o 5 vecinos vivos, sobrevive
                    elif gameState[x,y] == 1 and (neighbor == 5 or neighbor == 1):
                        copyState[x,y]=1
                        
                    else: copyState[x,y]=0
