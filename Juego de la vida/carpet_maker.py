...
def main():
    ...
    pygame.display.set_caption("Variante 4/2 (generador de patrones de alfombras)")
        ...
        for y in range(0, celX):
            for x in range(0, celY):
                ...
                if not pause: 
                    ...
                    if gameState[x,y] == 0 and (neighbor == 2):
                        copyState[x,y]=1
                    
                    #Si una célula esta viva y tiene 4 vecinos vivos, sobrevive
                    elif (gameState[x,y] == 1 and (neighbor == 4)):
                        copyState[x,y]=1
