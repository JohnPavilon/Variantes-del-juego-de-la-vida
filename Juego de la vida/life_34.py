...
def main():
    ...
    pygame.display.set_caption("Variante 34/34 (crece) «Vida 34»")
        ...
        for y in range(0, celX):
            for x in range(0, celY):
                ...
                if not pause: 
                    ...
                    if gameState[x,y] == 0 and (neighbor == 3 or neighbor == 4):
                        copyState[x,y]=1
                    
                    #Si una célula esta viva y tiene 3 o 4 vecinos vivos, sobrevive
                    elif gameState[x,y] == 1 and (neighbor == 3 or neighbor == 4):
                        copyState[x,y]=1
